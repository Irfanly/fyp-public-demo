          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-gray-500 mt-1">
                Manage all your event communications and participant interactions
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 max-w-6xl mx-auto w-full p-4 md:p-8">
        <Alert className="mb-6 bg-blue-50 border-blue-200">
          ...
          <AlertDescription className="text-blue-800">
            <span className="font-medium">Organization View:</span> As an organizer, your messages appear as announcements to all participants. You can also delete any message in your event's chatroom.
          </AlertDescription>
        </Alert>
